...
# For convenient tag management. [https://github.com/mbleigh/acts-as-taggable-on]
...
group :development do
  ...
  # Use model comments to declare fields of model [https://github.com/ctran/annotate_models]
  gem 'annotate'
